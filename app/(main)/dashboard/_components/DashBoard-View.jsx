...
const DashboardView = ({ insights = {} }) => {
  // Ensure salary data exists before mapping
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <OutlookInfo.icon className={`h-4 w-4 ${OutlookInfo.color}`} />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{insights.marketOutlook || "Unknown"}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{insights.demandLevel || "Unknown"}</div>
            <div
